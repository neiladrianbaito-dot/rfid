...
export default function DashboardPage() {
  ...
  return (
    <div
      className="relative min-h-screen p-2 lg:p-6"
    ...
    >
      {/* Overlay para readable pa rin ang text/cards sa taas ng NASA background image */}
      <div
      ...
      <div className={`relative z-10 space-y-8 ${isDark ? "text-slate-200" : "text-slate-800"}`}>
        <style>{`
